<%-- 
    ...
    Created on : Dec 1, 2017, 11:21:31 AM
...
<%           
    ArrayList<Producto> lista = ProductoDB.obtenerProductoF();
        %>
    </head>
    <body>
         <ul>
  ...
  <li><a class="active" href="ProductoFinal.jsp">PRODUCTO FINAL</a></li>
         ...
         <section id="empre">
            ...
            <table border="1" align="center" width="100%"  id="customers" >
             ...
             <td>   <p><%= p.getCantidad()%></p></td>
              ...
              <td><a href="CrearRequisicion.jsp?id=<%=p.getCodigo_producto()%>&nom=<%= p.getNombre_producto()%>&can=<%= p.getCantidad()%>&costoUni=<%=p.getCosto_unitario()%>&min=<%= p.getMinimo()%>&max=<%= p.getMaximo()%>&fam=2" class="button2">Requisicion</a></td>
              <td><a href="EditaProducto.jsp?id=<%=p.getCodigo_producto()%>&nom=<%= p.getNombre_producto()%>&can=<%= p.getCantidad()%>&costoUni=<%=p.getCosto_unitario()%>&min=<%= p.getMinimo()%>&max=<%= p.getMaximo()%>&fam=2" class="button2">Editar</a></td>
              <td><a href="EliminaProducto.jsp?id=<%= p.getCodigo_producto()%>&fam=2" class="button2">Eliminar</a></td>
            </tr> 
...
<h1 align="center">Ingresar Nuevo Producto Terminado</h1>
                <form action="ServletControlador" method="post">
                    <table border="0" width="300" align="center">
                    <input type="hidden" name="accion" value="addProducto">
                    <input type="hidden" name="txtfamilia" value="2">
                    <tr>
                        <td>Nombre: </td>
