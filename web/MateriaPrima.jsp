<%-- 
    ...
    Created on : Dec 1, 2017, 11:04:12 AM
...
<html>
    <head>
        ...
        <title>JMateria Prima</title>
         <link rel="stylesheet" href="estiloMenu.css" type="text/css"/>
         <link rel="stylesheet" href="estilo2.css" type="text/css"/>
<%           
    ArrayList<Producto> lista = ProductoDB.obtenerMP();
        %>
    </head>
    <body>
        <ul>
  ...
  <li><a class="active" href="MateriaPrima.jsp">MATERIA PRIMA</a></li>
         ...
         <section id="empre">
            ...
            <table border="1" align="center" width="100%" id="customers" >
             ...
             <td>   <p><%= p.getCantidad()%></p></td>
              ...
              <td><a href="CrearRequisicion.jsp?id=<%=p.getCodigo_producto()%>&nom=<%= p.getNombre_producto()%>&can=<%= p.getCantidad()%>&costoUni=<%=p.getCosto_unitario()%>&min=<%= p.getMinimo()%>&max=<%= p.getMaximo()%>&fam=1" class="button2">Requisicion</a></td>
              <td><a href="EditaProducto.jsp?id=<%=p.getCodigo_producto()%>&nom=<%= p.getNombre_producto()%>&can=<%= p.getCantidad()%>&costoUni=<%=p.getCosto_unitario()%>&min=<%= p.getMinimo()%>&max=<%= p.getMaximo()%>&fam=1" class="button2">Editar</a></td>
              <td><a href="EliminaProducto.jsp?id=<%= p.getCodigo_producto()%>&fam=1" class="button2">Eliminar</a></td>
            </tr> 
...
<h1 align="center">Ingresar Nuevo Producto de Materia Prima</h1>
